...
<head>
    ...
    <title>SI-COMMITEE || Documentos Registrados</title>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <textarea class="form-control" rows="6" name="comen"
                                                    ...
                                                    <div class="box-group" id="accordion">
                                                        ...
                                                        <div class="panel box box-primary">
                                                            ...
                                                            <div id="collapseOne" class="panel-collapse collapse in"
                                                                ...
                                                                <div class="card card-warning"
                                                                    style="background-color: #ffff; color: black">
                                                                    <div class="card-body">
                                                                        <div class="box-body">
                                                            ...
                                                            <div id="collapseThree" class="panel-collapse collapse show"
                                                                ...
                                                                <div class="card card-warning">
                                                                    <div class="card-body">
                                                                        <div class="box-body">
                                                                            <button type="button"
                                                                                class="btn btn-block btn-warning">Reglamento
                                                                                v3.0</button>
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                v4.0 2019</button>
                                                                            <button type="button"
                                                                                class="btn btn-block btn-warning">Formato
                                                                                presentacion Propuesta</button>
                                                                            <button type="button"
                                                                                class="btn btn-block btn-warning">Guia
                                                                                Elaboracion documento Final</button>
                                                                            <button type="button"
                                                                                class="btn btn-block btn-warning">Rubrica
                                ...
                                <div id="cpestana2">
                                    <div class="card card-warning">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="loginForm" action="validacionp.php" method="post"
                                                    ...
                                                    <div class="col-sm-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                placeholder="28/02/2020" readonly="readonly">
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="card-body">
                                                            <div class="form-group">
                                                                ...
                                                                <textarea class="form-control" rows="3"
                                                                    placeholder="Escriba el titulo"></textarea>
                                                            </div>
                                                        </div>
                                                        <!-- /.card-body -->
                                                    </form>
                              ...
                              ?>
                                            ...
                                            <div class="card-body">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="3"
                                                        ...
                                                        readonly="readonly"><?php echo ''.$titulo.''; ?></textarea>
                                                </div>
                                            </div>
                                            <!-- /.card-body -->
                                        </form>
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="exampleInputEmail1">Id otro
                                                            integrante...</label>
                                                        <input type="text" name="ID_estudiante1"
                                                            class="form-control ID_estudiante1" id="exampleInputEmail1"
                                                            placeholder="Id otro integrante...">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                            ...
                                                            <?php
						                                          $contador=0;
						                                        	  require("../connect_db.php");
						                                        		...
						                                        		$coor="Coordinador";    
						                                        		 require("../connect_db.php"); $dir="Director";
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="programa"
                                                            id="programa" value="<?php echo ''.$programa.''; ?>"
                                                            placeholder="Programa" readonly="readonly">
                                                    </div>
                                                </div>
                                    ...
                                    <form role="form">
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" id="login" value="Registrar"
