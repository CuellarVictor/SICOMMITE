                                                ...
                                                <center>
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="id" class="form-control"
                                                            placeholder="id" value="<?php echo $id?>" style="width: 50%"
                                                            readonly="readonly">
                                                    </div>
                                                </center>
                                            </div>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form id="loginForm1" action="enviarmsgcoor.php" method="post">
                                                ...
                                                <div class="box-footer">
                                                    ...
                                                    <center> <button type="submit" id="login2"
                                                                    ...
                                                                    <div class="box-header with-border">
                                                                        <h4 class="box-title">
                                                                            <a data-toggle="collapse"
                                                                                ...
                                                                                class="collapsed" style="color: white">
                                                                                Para Recordar
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                                    ...
                                                                    <div class="box-header with-border">
                                                                        <h4 class="box-title">
                                                                            <a data-toggle="collapse"
                                                                                ...
                                                                                style="color: white" class="collapsed">
                                                                                Importante
                                                                            </a>
                                                                        </h4>
                                                                    </div>
                                                                    ...
                                                                    <div class="card-body">
                                                                        <div class="box-body">
                                                                            <button type="button" class="btn btn-block"
                                                                                style="background: #343a40; color: white">Reglamento
                                                                                v3.0</button>
                                                                            ...
                                                                            <button type="button" class="btn btn-block"
                                                                                ...
                                                                                v4.0 2019</button>
                                                                            <button type="button" class="btn btn-block"
                                                                                style="background: #343a40; color: white">Formato
                                                                                presentacion Propuesta</button>
                                                                            <button type="button" class="btn btn-block"
                                                                                style="background: #343a40; color: white">Guia
                                                                                Elaboracion documento Final</button>
                                                                            <button type="button" class="btn btn-block"
                                                                                style="background: #343a40; color: white">Rubrica
